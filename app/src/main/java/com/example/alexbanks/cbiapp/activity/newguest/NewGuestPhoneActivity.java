    ...
    protected void initiateKeyboardListeners(){
        ...
        View.OnFocusChangeListener focusChangeListener = new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if(hasFocus){
                    NewGuestPhoneActivity.this.showCustomKeyboard(v);
                }else{
                    NewGuestPhoneActivity.this.hideCustomKeyPad();
                }
            }
        };
    ...
    protected void createKeyboards(){
        ...
        customKeyPadView.setOnKeyboardActionListener(new KeyboardView.OnKeyboardActionListener() {
            ...
            public void onKey(int primaryCode, int[] keyCodes) {
                View focusCurrent = NewGuestPhoneActivity.this.getWindow().getCurrentFocus();
